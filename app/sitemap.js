export default function sitemap() {
  ...
  return [
    ...
    { url: `${baseUrl}/blackdsn-portfolio/premium-a-content/`,        lastModified: new Date(), changeFrequency: 'yearly', priority: 0.75 },
    { url: `${baseUrl}/blackdsn-portfolio/ai-creative-retouching/`,   lastModified: new Date(), changeFrequency: 'yearly', priority: 0.75 },
    { url: `${baseUrl}/blackdsn-portfolio/brand-identity-packaging/`, lastModified: new Date(), changeFrequency: 'yearly', priority: 0.75 },
    // Blog posts
