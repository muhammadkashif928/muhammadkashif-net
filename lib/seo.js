export const siteConfig = {
  ...
  description:
    'Muhammad Kashif is an Amazon Brand Designer & A+ Content Specialist with 8+ years of experience serving private label sellers in the United States, UK, Canada, and worldwide. 200+ projects for US Amazon brands: A+ Content, product infographics, listing images, packaging design, and AI-powered lifestyle visuals. Remote-first, based in Kuching, Malaysia.',
...
export const seoKeywords = [
  ...
  // US & international market (primary client base)
  'Amazon brand designer for US sellers',
  'Amazon A+ Content designer USA',
  'Amazon listing designer for amazon.com sellers',
  'Amazon FBA product image designer',
  'Amazon design services for US private label brands',
  'hire Amazon designer for FBA business',
  'Amazon A+ Content design service US',
  'Amazon brand designer UK',
  'Amazon listing images designer Canada',
  'freelance Amazon designer for US brands',
  // Location
    ...
    '@graph': [
      {
        ...
        description: 'Amazon Brand Designer with 8+ years of experience and 200+ completed projects, primarily for private label sellers in the United States, United Kingdom, and Canada. Creates high-converting listing visuals, A+ Content, brand identity, packaging, and AI-powered product photography for amazon.com, amazon.co.uk, and amazon.ca brands. Works remotely worldwide from Kuching, Malaysia.',
