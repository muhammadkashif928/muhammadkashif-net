            ...
            <aside className="space-y-6">
              ...
              <div className="border-2 border-[#0a0a0a] p-6 shadow-brutal">
                ...
                <div className="flex flex-col gap-3">
                  {[
                    { title: 'Leather Hero — Purse Care Kit', slug: 'leather-hero-purse-care-kit', path: '/portfolio/leather-hero-purse-care-kit/' },
                    { title: 'Leather Hero — Furniture Salve', slug: 'leather-hero-furniture-salve', path: '/portfolio/leather-hero-furniture-salve/' },
                    ...
                    <Link
                      key={p.slug}
                      href={p.path ?? `/blackdsn-portfolio/${p.slug}/`}
