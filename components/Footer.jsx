      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
          ...
          <div className="col-span-2 sm:col-span-2 lg:col-span-1">
            <div className="mb-4">
              <img src="/images/logo-lockup-light.webp" alt="Muhammad Kashif" width={511} height={160} className="foot-logo nav-logo--light" />
              <img src="/images/logo-lockup-dark.webp" alt="" aria-hidden="true" width={511} height={160} className="foot-logo nav-logo--dark" />
            </div>
